...
const Company = () => (
    <main>
        <GlobeBanner>
            ...
            <h2>
                HYFIX is embarking on a mission to democratize sensor data by
                making it globally available, accessible, and affordable.
            </h2>
        </GlobeBanner>

        <FeatureSection>
            <p>
                As a first step towards this journey, we are building a global
                network of RTK reference stations to provide data and correction
                services that are:
            </p>
            <ul>
                <FeatureCard>
        ...
        <TextSection bg="blue">
            <p>
                Founded by pioneers in IoT, Sensor Fusion, Inertial Navigation
                and GNSS networking, we are headquartered in the heart of
                Silicon Valley.
            </p>
        </TextSection>
    </main>
